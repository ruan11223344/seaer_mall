<template>
    <div class="resetPass">
        <main class="resetPass-main">
            <div class="box">
                <h1>Please enter the Email Address currentlyassociated with your Afriby.com account</h1>
                <div class="box-title">Your Email Address:</div>
                <!-- 用户id -->
                ...
                <section class="box-useId box-code" style="marginTop: 40px;">
                    <div class="box-title">Verification Code:</div>
                ...
                <div class="box-btn" @click="onSubmit" id="Login-btn">Continue</div>
            </div>
        </main> 
    </div>
</template>
