    ...
    export default {
        ...
        methods: {
            ...
            filterEdit(data) {
                ...
                this.$set(this.formItem, 'name', data.product_info.product_name)
                this.$set(this.formItem, 'sku', data.product_info.product_sku_no)
                this.$set(this.formItem, 'keyword', data.product_info.product_keywords)
                this.$set(this.formItem.Price, 'animal', data.product_price.price_type)
                this.$set(this.formItem.Price, 'Base', data.product_price.base_price ? data.product_price.base_price[0] : {
                    min_order: 0,
                    unit: null,
                    min_order_price: 0,
                    max_order_price: 0,
